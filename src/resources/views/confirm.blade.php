...
<div class="confirm__content">
            ...
            <table class="confirm-table__inner">
                ...
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__text">
                        ...
                        <span class="confirm-table__text-gender"><?php
    ...
    <form class="confirm__button-modify" action="/" method="">
                <button class="confirm__button-modify-submit" type="submit">修正</button>
            </form>
</div>
